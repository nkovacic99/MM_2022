...
public class PlanetSpawner
{
    ...
    public PlanetSpawner()
    {
        ...
        bodyMaterial.SetColor("_EmissionColor", Color.white);
    }
    ...
    /**
     * Generates a Sphere mesh (with resolution specified in bodyResolution).
     * Lower resolution positively affects performance.
     */
    void GenerateMesh()
    {
